              ...
              <main className="packages-main">
                <header className="packages-header">
                  ...
                  <span className="packages-caption">
                    ...
                    <br className="packages-text03"></br>
                    <br></br>
                    <span>
                      This will redirect you my SetMore Schedule Page where you
                      will be able to appoint to your desired time frame
                      depending on the selected service&apos;s time length.
                    </span>
                    <br></br>
                    <br></br>
                    <span>
                      To see more detail about the service, click
                      &apos;&apos;See Details&quot;.
                    </span>
                    <br></br>
                  </span>
      ...
      <div className="packages-sale">
        <div className="packages-pricing-card">
          <span className="packages-text10">
            Limited Time Offer for First Buyers!
          </span>
        </div>
      </div>
      <div className="packages-pricing">
        <div className="packages-container04">
          <div className="packages-pricing-card1">
            ...
            <div className="packages-container06">
              <img alt="image" src="/15.png" className="packages-image3" />
              <span className="packages-text19">9</span>
              <span className="packages-text20">€</span>
            </div>
            <a
              ...
              className="packages-link button"
            >
              Book
            </a>
            ...
            <div className="packages-container07">
              <ul className="packages-ul1 list">
                ...
                <li className="packages-li11 list-item">
                  <span className="packages-text28"> Duration: 60 minutes</span>
                </li>
              </ul>
            </div>
            <div className="packages-container08">
              <img alt="image" src="/20.png" className="packages-image4" />
              <span className="packages-text29">11</span>
              <span className="packages-text30">€</span>
            </div>
            <a
              ...
              target="_blank"
              rel="noreferrer noopener"
              className="packages-link1 button"
            >
              Book
            </a>
          ...
          <div className="packages-pricing-card3">
            ...
            <div className="packages-container10">
              <img alt="image" src="/30.png" className="packages-image5" />
              <span className="packages-text41">
                <span>15</span>
                <br></br>
              </span>
              <span className="packages-text44">€</span>
            </div>
            <a
              ...
              target="_blank"
              rel="noreferrer noopener"
              className="packages-link2 button"
            >
              Book
            </a>
            <Link to="/taro-therapy" className="packages-navlink2">
              <span>See Details</span>
              <br></br>
            </Link>
          </div>
        ...
        <div className="packages-testimonials-button-container">
          <Link to="/testimonials" className="packages-navlink3">
            <div className="packages-testimonials-button get-started">
              <span className="packages-text47">
