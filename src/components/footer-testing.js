    ...
    <div className="footer-testing-container">
      <footer className="footer-testing-footer">
        ...
        <div className="footer-testing-container1">
          ...
          >
            <div className="footer-testing-container2"></div>
          </a>
          <a
            href="https://www.youtube.com/channel/UC9lhUhapaQ_e1dYt0yRgWGA"
            target="_blank"
            rel="noreferrer noopener"
            className="footer-testing-link01"
          >
            <div className="footer-testing-container3"></div>
          </a>
          <a
            href="mailto:guardianoflimitlesstruth@gmail.com?subject=SITE-"
            className="footer-testing-link02"
          >
            <div className="footer-testing-container4"></div>
          </a>
          <a
            href="https://www.instagram.com/guideoflimitlesstruth/"
            target="_blank"
            rel="noreferrer noopener"
            className="footer-testing-link03"
          >
            <div className="footer-testing-container5"></div>
          </a>
          <a
            href="https://www.twitch.tv/guideoflimitlesstruth"
            target="_blank"
            rel="noreferrer noopener"
            className="footer-testing-link04"
          >
            <div className="footer-testing-container6"></div>
          </a>
        </div>
      </footer>
      <footer className="footer-testing-footer1">
        <img
          alt="logo"
        ...
        />
        <div className="footer-testing-container7">
          <a
            href="https://discord.gg/RpAYvYT5DT"
            target="_blank"
            rel="noreferrer noopener"
            className="footer-testing-link05"
          >
            <img
              alt="image"
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer noopener"
            className="footer-testing-link06"
          >
            <img
              alt="image"
          ...
          <a
            href="mailto:guardianoflimitlesstruth@gmail.com?subject=SITE-"
            className="footer-testing-link07"
          >
            <img
              alt="image"
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer noopener"
            className="footer-testing-link08"
          >
            <img
              alt="image"
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer noopener"
            className="footer-testing-link09"
          >
            <img
              alt="image"
              ...
              className="footer-testing-image6"
            />
          </a>
        </div>
      </footer>
...
FooterTesting.defaultProps = {
  ...
  image_alt: 'logo',
  image_alt1: 'image',
  image_src: '/Branding/golt-logob-200h.png',
  image_alt3: 'image',
  image_alt5: 'image',
